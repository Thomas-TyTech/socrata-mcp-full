...
server.registerTool(
  assetPermissionsUpdateTool.name,
  {
...
server.registerTool(
  publishingScheduleGetTool.name,
  {
...
server.registerTool(
  workflowContextUpdateTool.name,
  {
